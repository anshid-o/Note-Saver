    ...
    <div class='column'>
        <div class='container'  style='opacity:1'>
            ...
            <div class='navbar'>
                ...
                <a class='active' href='#'><i class='fa fa-wpforms'></i></i> Post</a>
            ...
            <form action='postdb.php' method='post'>
                <div class='form-group'>
                    <div class='titblk'>
                        <div class='tita'><label for='title'>Title:</label></div>
                        <div class='tit'><input type='text' class='form-control' name='title' id='title' placeholder='Enter title' requuired></div>
                    </div>

                    <div class='tablk'>
                        <div class='ta'><label for='note'>Note:</label></div>
                        <div class='tab'><textarea name='note' id='note'></textarea></div>
                    </div>
                </div>
                <div class='but'>
